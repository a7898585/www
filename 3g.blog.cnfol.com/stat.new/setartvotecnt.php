...
if ($data['ArticleID'] < 1 || getVerifyStr($data['ArticleID']) != $_POST['code']) {
    ...
    //记录统计队列
    echo json_encode(array('errno' => 'failed', 'error' => '请求失败'));
    exit;
}
?>
