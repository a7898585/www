...
/*
  ...
  -----------------------------------------------------------------------------------------------------------------------
 */
$config['sysmodules'][1] = array('Mod_Affiche', '1', '公告', 'show_affiche.shtml');
$config['sysmodules'][2] = array('Mod_Stat', '2', '访问统计', 'show_stat.shtml');
$config['sysmodules'][3] = array('Mod_ArchiveList', '3', '文章存档', 'show_archive.shtml');
$config['sysmodules'][4] = array('Mod_Profile', '4', '个人档案', 'show_profile.shtml');
$config['sysmodules'][5] = array('Mod_Album', '5', '我的相册', 'show_album.shtml');
$config['sysmodules'][6] = array('Mod_NearVisitor', '6', '最近访客', 'show_newvisitor.shtml');
$config['sysmodules'][7] = array('Mod_Link', '7', '友情链接', 'show_friendlinks.shtml');
$config['sysmodules'][8] = array('Mod_ArticleSort', '8', '文章分类', 'show_articlesort.shtml');
$config['sysmodules'][9] = array('Mod_Calendar', '9', '日历', 'show_calendar.shtml');
$config['sysmodules'][10] = array('Mod_IndexArticle', '10', '文章列表', 'show_articlelist.shtml');
$config['sysmodules'][11] = array('Mod_RemmentArticle', '11', '推荐文章', 'show_remmendatrile.shtml');
$config['sysmodules'][12] = array('Mod_NearVisitorTo', '12', '最近到过', 'show_nearvisitto.shtml');
$config['sysmodules'][13] = array('Mod_MicroBlog', '13', '微博', 'show_mircroblogcp.shtml');
...
$config['hw']['username'] = 'dbuser_lifeng';
$config['hw']['password'] = 'JKJKFU787JJ3ljh';
