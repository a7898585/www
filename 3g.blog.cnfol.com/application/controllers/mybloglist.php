...
class MyBlogList extends MY_Controller {
    ...
    function getMsg() {
        ...
        if ($UserID == '355031') {
            error_log(print_r(date('Y-m-d H:i:s', $rs['dyTime']), true) . '|' . date('Y-m-d H:i:s', $dyTime) . '\r\n', 3, '/home/httpd/logs/adyTime.log');
        }
    ...
    function Action($domainname) {
        ...
        switch ($act) {
            case 'add':
                ...
                //error_log(print_r($matchesPic,true), 3, '/home/httpd/logs/a123131.log');
