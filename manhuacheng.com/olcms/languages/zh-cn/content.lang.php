...
$LANG['publish_to_linkage'] = '行业分类选择';
//内容添加表单部分
...
$LANG['please_check_category'] = '可能你没有该栏目下的管理权限，请联系管理员';
...
$LANG['correlation_success'] = '关联成功';
$LANG['start_update_urls'] = '开始更新URL ...';
$LANG['start_relevance_comic'] = '开始关联采集漫画 ...';
$LANG['start_relevance_cartoon'] = '开始关联采集动漫 ...';
$LANG['updating'] = '正在更新';
...
$LANG['updatehits_tips'] = '1、重新生成没有点击数的数据<BR>2、在不需要详细点击次数的模型时可以不更新';
$LANG['batch_comic_tips'] = '1、只会关联已经通过程序抓取图片的记录<BR>2、每轮更新请勿填写太大数值,以免数据库压力过大';
$LANG['updatedesc_tips'] = '1、生成摘要';
$LANG['batch_relation'] = '1、尽量选择精确的更新条件<BR>2、两种更新模式：1、在安装sphinx，2、没有安装sphinx时对数据库压力大';
$LANG['reject_msg'] = '未通过理由';
$LANG['group_disable'] = '您所在的会员组已被删除，请联系管理员！';
$LANG['parent_typeid'] = '上级类别';
