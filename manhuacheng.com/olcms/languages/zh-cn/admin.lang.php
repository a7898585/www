...
/*Language Format:
Add a new file(.lang.php) with your module name at /olcms/languages/
translation save at the array:$LANG
*/

//index
$LANG['admin_site_title'] = 'olcms - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['olcms_title'] = 'OLCMS内容管理系统';
...
$LANG['main_safety_permissions'] = '※ 强烈建议您将olcms目录设置为644（linux/unix）或只读（NT）';
...
$LANG['setting_web_cfg'] = '站点配置';
$LANG['setting_attach_cfg'] = '附件配置';
$LANG['setting_mail_cfg'] = '邮箱配置';
$LANG['setting_member_cfg'] = '会员设置';
$LANG['setting_manage_cfg'] = '管理配置';
$LANG['setting_others_cfg'] = '其他选项';
$LANG['setting_value_final'] = '是否生产全局变量';
$LANG['application_son'] = '应用于子栏目';
$LANG['setting_value_name'] = '变量名';
$LANG['setting_value_value'] = '变量值';
$LANG['setting_value_type'] = '变量类型';
$LANG['setting_value_description'] = '变量描述';
$LANG['setting_value_group'] = '所属组';
...
$LANG['setting_not_allow_typeid'] = '禁止显示的漫画分类id';
...
$LANG['setting_uc'] = '启用UCenter';
$LANG['update_uc_cache'] = '更新缓存';
$LANG['setting_uc_appid'] = '应用ID';
$LANG['setting_uc_uc_api_url'] = '接口地址';
$LANG['setting_uc_auth_key'] = '加密密钥';
$LANG['setting_uc_version'] = '版本号';
$LANG['must_be_number'] = '必须为数字';
$LANG['must_be_32_w'] = '为uc中该设置的密钥';
$LANG['content_manage_model'] = '内容管理模式';
$LANG['content_manage1'] = '模型分类管理';
$LANG['content_manage2'] = '栏目分类管理';


$LANG['setting_succ'] = '配置修改成功';
$LANG['setting_fail'] = '配置修改失败';
...
$LANG['setting_end_with_xx'] = '请以“,”分隔,只允许填入数字';
...
$LANG['setting_uc_type'] = '请填写接口地址，格式为：http://www.uc.cn,结尾不包含“/”';
...
$LANG['linkage_alias'] = '菜单别名';
$LANG['linkage_subadd_description'] = '菜单名称|别名<br/>如：厦门|xiamen';
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 OLCMS可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
OLCMS可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.olcms.cn/';
...
$LANG['meta_title_home'] = '当前栏目标题';
$LANG['meta_keywords_home'] = '当前栏目关键字';
$LANG['meta_description_home'] = '当前栏目描述';
$LANG['meta_title_list'] = '子栏目标题';
$LANG['meta_keywords_list'] = '子栏目关键字';
$LANG['meta_description_list'] = '子栏目描述';
$LANG['meta_title_show'] = '详细页标题';
$LANG['meta_keywords_show'] = '详细页关键字';
$LANG['meta_description_show'] = '详细页描述';

$LANG['role_private'] = '角色权限<br />（单列没有选择默认为允许）';
$LANG['group_private'] = '会员组权限<br />（单列没有选择默认为允许）';
$LANG['group_name'] = '会员组名称';
$LANG['allow_vistor'] = '允许访问';
$LANG['allow_contribute'] = '允许投稿';
$LANG['allow_list'] = '允许查看列表页';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.olcms.cn/';
$LANG['site_domain_ex2'] = '格式应该为http://www.olcms.cn/，请以‘/’结束';
...
$LANG['olcms_news'] = 'olcms官方新闻';
$LANG['update_online'] = '进行在线更新';
$LANG['setting_delayviewcount'] = '缓存统计次数';
$LANG['setting_gather_img'] = '开启突破图片防采集';
$LANG['updatehost'] = '升级地址';
$LANG['target_blank'] = '新窗口';
$LANG['target_self'] = '本窗口';
$LANG['target_parent'] = '父窗口';
$LANG['islist'] = '是否栏目页';
$LANG['categorypage'] = '栏目页';
$LANG['listpage'] = '列表页';
