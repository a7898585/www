...
$LANG['sina_login_notice'] = '使用新浪微博连接登录OLCMS,将精彩内容分享到新浪微博。';
...
$LANG['isurl'] = '是否为外部链接';
$LANG['url'] = '外部链接';
$LANG['please_check_uc'] = '请告知管理员UC配置错误啦！';
$LANG['member_no_delete_all'] = 'UC会员没有全部删除';
$LANG['default_modelid'] = '默认会员模型';
