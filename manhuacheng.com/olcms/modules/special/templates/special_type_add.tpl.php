...
<div class="pad-lr-10">
<form action="?m=special&c=special&a=add_type" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<th></th>
		<td><input type="hidden" name="forward" value="?m=special&c=special&a=add_type"> <input
