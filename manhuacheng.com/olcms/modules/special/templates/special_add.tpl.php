...
<div id="div_setting_1" class="contentList pad-10">
	<table width="100%" class="table_form ">
		...
		<tr>
			...
			<td><input name="special[alias]" id="title" class="input-text" value="" type="text" size="40"></td>
		</tr>
		<tr>
		...
		<tr>
	 	   ...
	 	   <td valign="top"><?php echo form::radio(array('1'=>L('yes'), '0'=>L('no')),'0', 'name="special[isurl]"');?></td>
		</tr>
		<tr id="html_div" style="display:none;">
	    	<th align="right"  valign="top"><?php echo L('ishtml')?>：</th>
	        <td valign="top"><?php echo form::radio(array('1'=>L('yes'), '0'=>L('no')),'0', 'name="special[ishtml]"');?>
	        </td>
	    </tr>
	    <tr id="file_div" style="display:none;">
...
<table width="100%" class="table_form ">
	...
	<tr>
		<th>metatitle：</th>
		<td><textarea name="special[metatitle]" id="metatitle" cols="50" rows="6"></textarea></td>
	</tr>
	<tr>
		<th>metakeword：</th>
		<td><textarea name="special[metakeyword]" id="metakeyword" cols="50" rows="6"></textarea></td>
	</tr>
	<tr>
		<th>metadescription：</th>
		<td><textarea name="special[metadescription]" id="metadescription" cols="50" rows="6"></textarea></td>
	</tr>
	<tr>
