...
<div id="div_setting_1" class="contentList pad-10">
	<table class="table_form" width="100%" cellspacing="0">
		...
		<tr>
			<th width="20%"><?php echo L('sortid')?>：</th>
			<td><?php echo form::select($typedata, $info['sortid'], 'name="special[sortid]"', L('please_select'))?></td>
	    </tr>
		<tr>
			<th><?php echo L('special_alias')?>：</th>
			<td><input name="special[alias]" id="title" class="input-text" value="<?php echo $info['alias'];?>" type="text" size="40"></td>
		</tr>
			<tr>
			...
			<tr>
	  		    <th align="right"  valign="top"><?php echo L('is_url')?>：</th>
			     <td valign="top"><?php echo form::radio(array('1'=>L('yes'), '0'=>L('no')),$info['isurl'], 'name="special[isurl]"');?></td>
			</tr>
			<tr id="html_div" style="display:<?php if($info['ishtml']) {?> <?php } else {?>none<?php }?>;">
...
<div id="div_setting_2" class="contentList pad-10 hidden">
	<table width="100%" class="table_form ">
		...
		<tr>
			...
			<tr>
				<th>metatitle：</th>
				<td><textarea name="special[metatitle]" id="metatitle" cols="50" rows="6"><?php echo $info['metatitle'];?></textarea></td>
			</tr>
			<tr>
				<th>metakeword：</th>
				<td><textarea name="special[metakeyword]" id="metakeyword" cols="50" rows="6"><?php echo $info['metakeyword'];?></textarea></td>
			</tr>
			<tr>
				<th>metadescription：</th>
				<td><textarea name="special[metadescription]" id="metadescription" cols="50" rows="6"><?php echo $info['metadescription'];?></textarea></td>
			</tr>
		<tr>
...
$("input:radio[name='special[isurl]']").click(function (){
	if($("input:radio[name='special[isurl]'][checked]").val()==0) {
		$("#html_div").hide();
		$("#file_div").hide();
	} else if($("input:radio[type='radio'][checked]").val()==1) {
		$("#html_div").show();
