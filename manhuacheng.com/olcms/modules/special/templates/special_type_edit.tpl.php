...
<div class="pad-lr-9">
<form action="?m=special&c=special&a=edit_type&typeid=<?php echo $typeid; ?>&typedir=<?php echo $typedir; ?>&parentid=<?php echo $parentid; ?>" method="post" name="myform" id="myform">
<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
	...
	<tr>
		<th width="100"><?php echo L('type_alias')?>：</th>
		<td><input type="text" name="type[typedir]" id="type_alias"
			size="20" class="input-text" value="<?php echo $typedir;?>"></td>
	</tr>
	<tr>
		<th width="100"><?php echo L('is_url')?>：</th>
		<td><?php echo form::radio(array('0'=>L('no'), '1'=>L('yes')), 0, 'name="isurl"');?></td>
	</tr>
	<tr>
