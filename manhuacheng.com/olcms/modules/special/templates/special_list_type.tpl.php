...
<table width="100%" cellspacing="0">
	<thead>
		<tr>
			...
			<th width="12%" align="center"><?php echo L('type_description')?></th> 
...
?>
	<tr>
		...
		<td><a href="<?php echo $info['url']?>" target="_blank"><?php echo $info['name']?></a></td>
		<td align="center" width="12%"><?php echo $info['description'];?></td>
...
function edit(id, name) {
	...
	window.top.art.dialog({title:'<?php echo L('edit')?> '+name+' ',id:'edit',iframe:'?m=link&c=link&a=edit_type&typeid='+id,width:'450',height:'300'}, function(){var d = window.top.art.dialog({id:'edit'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;}, function(){window.top.art.dialog({id:'edit'}).close()});
}
function checkuid() {
	var ids='';
