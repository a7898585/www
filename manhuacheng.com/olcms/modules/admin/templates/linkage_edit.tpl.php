...
<tr>
  ...
  <td>
<?php echo form::select_linkage($info['keyid'], 0, 'info[parentid]', 'parentid', L('empty'), $_GET['parentid'])?>
  </td>
  </tr>
  <?php } ?>
<tr>
...
<tr>
<td><?php echo L('linkage_alias')?></td>
<td>
<input type="text" name="info[alias]" value="<?php echo $alias?>" class="input-text" id="alias" size="30"></input>
</td>
</tr>
