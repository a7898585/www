...
<table width="100%" class="table_form ">
      ...
      <tr>
        ...
        <td>
		<?php echo form::select_category('category_content',$parentid,'name="info[parentid]"',L('please_select_parent_category'),0,0);?>
		</td>
      </tr>
      <tr>
	...
	<tr>
        <th><?php echo L('application_son')?>：</th>
      <td>
	  <input type='radio' name='info[app_all]' value='<?php echo $catid;?>' <?php if($app_all) echo 'checked';?>> <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='info[app_all]' value='0' <?php if(!$app_all) echo 'checked';?> > <?php echo L('no');?></td>
      </tr>
<tr>
     ...
     <tr>
		<th><?php echo L('link_target')?>：</th>
		<td><input type="radio" name="setting[target]" size="50" value="_blank" <?php echo ($setting['target'] == '_blank' ? 'checked': '')?> > <?php echo L('target_blank');?> <input type="radio" name="setting[target]" size="50" value="_self" <?php echo ($setting['target'] == '_self' || !$setting['target'] ? 'checked': '')?> > <?php echo L('target_self');?><input type="radio" name="setting[target]" size="50" value="_parent" <?php echo ($setting['target'] == '_parent' ? 'checked': '')?> ><?php echo L('target_parent');?></td>
	 </tr>
	  <tr>
		<th><?php echo L('islist');?>：</th>
		<td><input type="radio" name="setting[islist]" size="50" value="1" <?php echo ($setting['islist'] == 1 ? 'checked': '')?> ><?php echo L('categorypage');?> <input type="radio" name="setting[islist]" size="50" value="0" <?php echo (!$setting['islist']? 'checked': '')?> > <?php echo L('listpage');?></td>
	 </tr>
</table>
...
<table width="100%" class="table_form">
	...
	<tr>
      <th><?php echo L('application_son');?>：</th>
      <td>
	  <input type='radio' name='setting[app_son]' value='1' <?php if($setting['app_son']) echo 'checked';?> > <?php echo L('yes');?>&nbsp;&nbsp;&nbsp;&nbsp;
	  <input type='radio' name='setting[app_son]' value='0' <?php if(!$setting['app_son']) echo 'checked';?>  > <?php echo L('no');?>
	  </td>
    </tr>
<tr>
...
<tr> 
      <th width="20%"><?php echo L('urlrule_func')?> :</th>
       <td><?php echo L('complete_part_path');?>： {$parent_catname} ，<?php echo L('category_path');?>：{$catname}
		<?php if(is_array($f_datas)){?>
		<?php foreach ($f_datas as $v){?> ，<?php echo $v['name'];?>：{$<?php echo $v['field'];?>}<?php }?><?php }?>
	</td>
    </tr>
	<tr>
      <th width="200"><?php echo L('meta_title_home');?></th>
      <td>
      <input type="text" name='setting[meta_title_home]' id='meta_title_home' value="<?php echo $setting['meta_title_home'];?>" size="72">
</td>
    </tr>
    <tr>
      <th ><?php echo L('meta_keywords_home');?></th>
      <td><input type="text" name='setting[meta_keywords_home]' id='meta_keywords_home' value="<?php echo $setting['meta_keywords_home'];?>" size="64" /></td>
    </tr>
    <tr>
      <th ><?php echo L('meta_description_home');?></th>
      <td><textarea name='setting[meta_description_home]' id='meta_description_home' style="width:90%;height:60px"><?php echo $setting['meta_description_home'];?></textarea></td>
    </tr>
	<tr>
      <th width="200"><?php echo L('meta_title_list');?></th>
      <td>
      <input type="text" name='setting[meta_title_list]' id='meta_title' value="<?php echo $setting['meta_title_list'];?>" size="72">
</td>
    </tr>
    <tr>
      <th ><?php echo L('meta_keywords_list');?></th>
      <td><input type="text" name='setting[meta_keywords_list]' id='meta_keywords_list' value="<?php echo $setting['meta_keywords_list'];?>" size="64"></td>
    </tr>
    <tr>
      <th ><?php echo L('meta_description_list');?></th>
      <td><textarea name='setting[meta_description_list]' id='meta_description' style="width:90%;height:60px"><?php echo $setting['meta_description_list'];?></textarea></td>
    </tr>
	<tr>
      <th width="200"><?php echo L('meta_title_show');?></th>
      <td>
      <input type="text" name='setting[meta_title_show]' id='meta_title' value="<?php echo $setting['meta_title_show'];?>" size="72">
</td>
    </tr>
    <tr>
      <th ><?php echo L('meta_keywords_show');?></th>
      <td><input type="text" name='setting[meta_keywords_show]' id='meta_keywords_show' value="<?php echo $setting['meta_keywords_show'];?>" size="64"></td>
    </tr>
    <tr>
      <th ><?php echo L('meta_description_show');?></th>
      <td><textarea name='setting[meta_description_show]' id='meta_description' style="width:90%;height:60px"><?php echo $setting['meta_description_show'];?></textarea></td>
    </tr>
</table>
</div>
	  ...
	  <tr>
        ...
        <td>
			<table width="100%" class="table-list">
			  <thead>
				<tr>
				  <th align="left"><?php echo L('group_name');?></th><th><?php echo L('allow_vistor');?></th><th><?php echo L('allow_list');?></th><th><?php echo L('allow_contribute');?></th>
			  </tr>
			    </thead>
				 <tbody>
			<?php
			...
			?>
				  ...
				  <td align="center"><input type="checkbox" name="priv_groupid[]"  <?php echo $this->check_category_priv('list',$_value['groupid'],0);?> value="list,<?php echo $_value['groupid'];?>" ></td>
