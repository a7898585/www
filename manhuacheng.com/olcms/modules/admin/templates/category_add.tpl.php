 ...
 <tr>
	...
	<tr>
     ...
     <tr>
		...
		<td><input type="radio" name="setting[target]" size="50" value="_blank" > <?php echo L('target_blank');?> <input type="radio" name="setting[target]" size="50" value="_self"  checked > <?php echo L('target_self');?><input type="radio" name="setting[target]" size="50" value="_parent" ><?php echo L('target_parent');?></td>
	 </tr>
	  <tr>
		<th><?php echo L('islist');?>：</th>
		<td><input type="radio" name="setting['islist']" size="50" value="0" checked> <?php echo L('listpage');?>   <input type="radio" name="setting['islist']" size="50" value="1" ><?php echo L('categorypage');?> </td>
	 </tr>
</table>
...
<table width="100%" class="table_form ">
	...
	<tr>
      ...
      <td>
      <input type="text" name='setting[meta_title_list]' id='meta_title' value="" size="72">
</td>
    </tr>
    <tr>
      <th ><?php echo L('meta_keywords_list');?></th>
      <td><input type="text" name='setting[meta_keywords_list]' id='meta_keywords_list' value="" size="64"></td>
    </tr>
    <tr>
      <th ><?php echo L('meta_description_list');?></th>
      <td><textarea name='setting[meta_description_list]' id='meta_description' style="width:90%;height:60px"></textarea></td>
    </tr>
	<tr>
      <th width="200"><?php echo L('meta_title_show');?></th>
      <td>
      <input type="text" name='setting[meta_title_show]' id='meta_title' value="" size="72">
</td>
    </tr>
    <tr>
      <th ><?php echo L('meta_keywords_show');?></th>
      <td><input type="text" name='setting[meta_keywords_show]' id='meta_keywords_show' value="" size="64"></td>
    </tr>
    <tr>
      <th ><?php echo L('meta_description_show');?></th>
      <td><textarea name='setting[meta_description_show]' id='meta_description' style="width:90%;height:60px"></textarea></td>
    </tr>
</table>
</div>
	  ...
	  <tr>
        ...
        <td>
			...
			?>
				  ...
				  <td align="center"><input type="checkbox" name="priv_groupid[]"   value="list,<?php echo $_value['groupid'];?>" ></td>
				  <td align="center"><input type="checkbox" name="priv_groupid[]"  <?php if($_value['groupid']!=8){?>checked<?php }?> value="add,<?php echo $_value['groupid'];?>" ></td>
			  </tr>
			<?php }?>
			 </tbody>
			</table>
