...
<table width="100%" class="table_form ">
	<tr>
	  ...
	  <tr>
		...
		<td><input type="radio" name="setting[target]" size="50" value="_blank" <?php echo ($setting['target'] == '_blank' || !$setting['target'] ? 'checked': '')?> >新窗口 <input type="radio" name="setting[target]" size="50" value="_self" <?php echo ($setting['target'] == '_self' ? 'checked': '')?> > 本窗口<input type="radio" name="setting[target]" size="50" value="_parent" <?php echo ($setting['target'] == '_parent' ? 'checked': '')?> >父窗口</td>
	 </tr>
	  <tr>
