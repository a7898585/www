...
<fieldset id="history" style="display:none">
	...
	<?php if($pages):?><div id="pages"><a class="a1"><?php echo $pages['counts'];?> <?php echo L('page_item');?></a> <a class="a1"><?php echo $pages['page'];?>/<?php echo $pages['pages'];?></a> <a href="<?php echo $pages['previous'];?>"><?php echo L('previous');?></a> <?php echo $pages['lists'];?> <a href="<?php echo $pages['next'];?>"><?php echo L('next');?></a></div><?php endif;?>
</fieldset>
