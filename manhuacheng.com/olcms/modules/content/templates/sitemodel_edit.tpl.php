...
<fieldset>
  ...
  <tr>
    <th width="120"> 模型类型：</th>
    <td class="y-bg">双表：<input type="radio" name="info[type]" value='0' <?php if($type!=3){?>checked<?php }?>/>&nbsp;&nbsp;&nbsp;&nbsp;单表：<input type="radio" name="info[type]" value='3' <?php if($type==3){?>checked<?php }?>/></td>
  </tr>
  <tr>
