...
<table width="100%"  class="table_form">
  <tr>
    ...
    <td class="y-bg"><?php echo form::select($typedata,'0','name=info[parentid]','作为一级类别')?></td>
  </tr>
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="info[typedir]" id="name" size="30" value=""/></td>
  </tr>
    <tr>
