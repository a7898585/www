...
<form action="?m=content&c=create_html&a=batch_relation" method="post" name="myform">
...
<!--
	...
	function change_model(modelid) {
		...
		window.location.href='?m=content&c=create_html&a=batch_relation&modelid='+modelid;
	}
//-->
</script>