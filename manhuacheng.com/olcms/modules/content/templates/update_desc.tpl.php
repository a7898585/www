...
<form action="?m=content&c=create_html&a=update_desc" method="post" name="myform">
...
<?php echo $string;?>
      ...
      <td><font color="red"><?php echo L('every_time');?> <input type="text" name="pagesize" value="100" size="4"> <?php echo L('information_items');?></font>
  <font color="red">,从副表字段名为：<input type="text" name=field value="content" size="10">中提取<input type="text" name="stringlength" value="250" size="5">个字作为摘要内容</font>    
      </td>
    </tr>
	<tr> 
...
<!--
	...
	function change_model(modelid) {
		...
		window.location.href='?m=content&c=create_html&a=update_desc&modelid='+modelid;
	}
//-->
</script>