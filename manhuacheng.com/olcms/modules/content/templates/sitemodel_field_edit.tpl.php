...
<?php echo form::select($fields,$formtype,'name="info[formtype]" id="formtype" onchange="javascript:field_setting(this.value);" disabled',L('select_fieldtype'));?>
	...
	<tr> 
      ...
      <input type="radio" name="info[issystem]" id="field_basic_table1" value="1" <?php if($issystem) echo 'checked';?> disabled> <?php echo L('yes');?><?php if($model_cache[$modelid]['type']!=3){?> <input type="radio" id="field_basic_table0" name="info[issystem]" value="0" onclick="$('#issystem').val('0');" <?php if(!$issystem) echo 'checked';?> disabled> <?php echo L('no');?><?php }?></td>
    </tr>
	<tr> 
...
<option value="/^[0-9]{6}$/"><?php echo L('zip');?></option>
	...
	<tr> 
      ...
      <td><input type="radio" name="info[isbase]" value="1"  <?php if($isbase==1) echo 'checked';?>> <?php echo L('yes');?> <input type="radio" name="info[isbase]" value="0" <?php if($isbase==0) echo 'checked';?>> <?php echo L('no');?><input type="radio" name="info[isbase]" value="2" <?php if($isbase==2) echo 'checked';?>> <?php echo L('no_display');?> </td>
    </tr>
	<tr> 
	...
	<tr> 
      ...
      <td><input type="radio" name="info[isseo]" value="1" <?php if($isseo) echo 'checked';?> /> <?php echo L('yes');?> <input type="radio" name="info[isseo]" value="0" <?php if(!$isseo) echo 'checked';?>/> <?php echo L('no');?></td>
    </tr>
	<tr> 
