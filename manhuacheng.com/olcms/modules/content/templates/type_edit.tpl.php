...
<table width="100%"  class="table_form">
  <tr>
    <th width="80"><?php echo L('parent_typeid')?>：</th>
    <td class="y-bg"><?php echo form::select($typedata,$parentid,'name=info[parentid]','作为一级类别')?></td>
  </tr>
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="info[typedir]" id="name" size="30" value="<?php echo $typedir;?>"/></td>
  </tr>
    <tr>
