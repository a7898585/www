<table cellpadding="2" cellspacing="1" width="98%">
	<tr> 
      <td width="100">操作&nbsp;&nbsp;<input type="checkbox" name="setting[isfunc]" value="1" <?php if($setting['isfunc']) echo 'checked';?>></td>
      <td>数据源：<?php echo form::select($exists_field,$setting['source'],'name="setting[source]"')?> 处理函数：<?php echo form::radio($func,$setting['func'],'name="setting[func]"')?></td>
    </tr>
	<tr> 
