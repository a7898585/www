<table cellpadding="2" cellspacing="1" width="98%">
    ...
    <tr>
	<td>选择方式：</td><td>  <input name="setting[selected]" value="0" type="radio" <?php if(!$setting['selected']) echo 'checked';?>>
       单选模式
        <input name="setting[selected]" value="1" type="radio" <?php if($setting['selected']==1) echo 'checked';?>>
        多选模式         	
	</td></tr>	
</table>
