DROP TABLE IF EXISTS `olcms_mood`;
CREATE TABLE IF NOT EXISTS `olcms_mood` (
  `id` int(10) unsigned NOT NULL auto_increment,
  `modelid` smallint(4) unsigned NOT NULL default '0' COMMENT '模型id',
  `catid` smallint(4) unsigned NOT NULL default '0' COMMENT '栏目id',
