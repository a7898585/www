$(document).ready(function(){
    ...
    $('#big-pic img').LoadImage(false, 955, 1024,$("#load_pic").attr('rel'));
    if(liulanqi !='ie'){
        $("#picnum").html("(第"+picid+"页/总"+totalnum+"页)");
...
function showpic(type, replay) {
    ...
    if(type=='next' || type=='pre') {
        ...
        $('#big-pic img').LoadImage(false, 955, 1024,$("#load_pic").attr('rel'));
        if(liulanqi !='ie'){
            $("#picnum").html("(第"+i+"页/总"+totalnum+"页)");
        ...
        $('#big-pic img').LoadImage(false, 955, 1024,$("#load_pic").attr('rel'));
        if(liulanqi !='ie'){
            $("#picnum").html("(第"+type+"页/总"+totalnum+"页)");
