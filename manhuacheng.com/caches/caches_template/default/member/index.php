...
<?php include template('member', 'left'); ?>
    <div class="col-auto">
	<?php if(defined('IN_ADMIN')  && !defined('HTML')) {echo "<div class=\"admin_piao\" pc_action=\"announce\" data=\"op=announce&tag_md5=3aaf7c1b3c28a790b698f25e4680db9b&action=lists&num=1&cache=3600\"><a href=\"javascript:void(0)\" class=\"admin_piao_edit\">编辑</a>";}$tag_cache_name = md5(implode('&',array()).'3aaf7c1b3c28a790b698f25e4680db9b');if(!$data = tpl_cache($tag_cache_name,3600)){$announce_tag = pc_base::load_app_class("announce_tag", "announce");if (method_exists($announce_tag, 'lists')) {$data = $announce_tag->lists(array('limit'=>'1',));}if(!empty($data)){setcache($tag_cache_name, $data, 'tpl_data','','template',3600);}}?>
		<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
    	<div class="point" id='announcement' style="display:none">
        	<a href="javascript:hide_element('announcement');setcookie('announcement', 1);" hidefocus="true" class="close"><span><?php echo L('close');?></span></a>
            <div class="content">
    	...
    	<div class="col-auto">
        	<div class="col-1 member-info">
            	<div class="content">
					...
					<a title="<?php echo L('modify').L('avatar');?>" href="index.php?m=member&c=index&a=account_manage_avatar&t=1"><img src="<?php echo $avatar;?>" width="60" height="60" onerror="this.src='<?php echo $uc_api_url;?>/statics/images/member/nophoto.gif'"></a>
					</div>
                  <div class="col-auto">
...
<script type="text/javascript" src="<?php echo JS_PATH;?>member_announcement.js"></script>
