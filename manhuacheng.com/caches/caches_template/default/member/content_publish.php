	...
	<div class="col-auto">
		<div class="col-1 ">
			...
			<form method="post" action="" id="myform" name="myform">
				...
				<!--
					function c_c(catid) {
						location.href='index.php?m=member&c=content&a=publish&catid='+catid;
					}
				//-->
				</script>
					<tr>
						<th><?php echo L('please_select_cat');?></th>
						<td><?php echo form::select_category('category_content', $catid, 'name="info[catid]" onchange="javascript:c_c(this.value);"','','',0,1);?></td>
					</tr>
				<?php } ?>
