...
<body>
<div id="header">
	<div class="logo"><img src="<?php echo IMG_PATH;?>beta/logo.jpg" height="60" /><h3><?php echo L('member_center');?></h3></div>
	<?php $siteinfo = siteinfo();?>
	<?php $this->menu_db = pc_base::load_model('member_menu_model');?>
	<?php $menu = $this->menu_db->select(array('display'=>1), '*', 20 , 'listorder');?>
