...
<div class="main">
	<div class="col-left">
    	<div class="crumbs"><a href="<?php echo siteurl();?>">首页</a><span> > </span><?php echo catpos($catid);?> 标签：<font color="red"><?php echo $tag;?></font> 总共有 <?php echo $total;?> 条记录</div>
...
<script language="JavaScript" src="<?php echo APP_PATH;?>api.php?op=count&id=<?php echo $tagrs['id'];?>&action=tag"></script>
