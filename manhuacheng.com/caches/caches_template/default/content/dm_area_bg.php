<?php defined('IN_OLCMS') or exit('No permission resources.'); ?><?php $SEO['title']=$areaname."动漫_".$areaname."在线动漫_".$areaname."在线动漫观看 - 漫画城";?>
<?php $SEO['keyword']=$areaname."动漫,".$areaname."动漫观看，最新".$areaname."动漫,".$areaname."动漫";?>
<?php $SEO['description']="漫画城为您提供".$areaname."动漫，".$areaname."动漫观看，最新".$areaname."动漫,".$areaname."动漫，漫画城是最齐全的动漫大全、国内最大的动漫城。";?>
<?php $footer_txt = "漫画城".$areaname."动漫频道为您提供".$areaname."动漫，".$areaname."动漫观看，最新".$areaname."动漫,热门".$areaname."动漫，漫画城是最齐全的动漫大全、国内最大的动漫城。"?>
<?php include template("content","header"); ?>
<?php include template("content","dm_nav"); ?>
	<div class="left c666">您现在的位置：&nbsp;<a class="LinkPath" href="/">首页</a>&nbsp;&gt;&nbsp;<a class="LinkPath" href="/dongman">动漫城</a>&nbsp;&gt;&nbsp;<?php echo $areaname;?>地区动漫</div>
    <div class="middle_div1">
    	<div class="middle_div1_le" style="border:1px solid #AEDD5E">
        	<div class="jingdian_tit">
            	<i class="icon"></i>
            	<h3><?php echo $areaname;?>地区动漫列表</h3>
            </div>
