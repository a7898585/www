...
$config['K1011'] = 'Memberblog_getMemberBlogList_{QryData}_{Type}_{QryCount}';
...
$config['K1015add'] = 'Blogarticle_getMemberArticleList_Count_{MemberID}_{StartDate}_{EndDate}';
...
//博客不同类型文章列表 
$config['K2021'] = 'Blogarticle_otherTypeArticle_{StartNo}_{QryCount}_{TagID}_{IsUsed}_{Groups}';
//获取个人博客最新的那篇文章
$config['K2031'] = 'Blogarticle_getFirst_{MemberID}';

//获取黑名单列表用(暂时只用于留言页)
$config['K2075'] = 'get_blacklist_leaveuse_{userid}';

//粉丝，我关注的，相互关注数
$config['K2076'] = 'get_fans_Fllower_num_{userid}';

//查询好友关系状态
$config['K2077'] = 'query_relation_status_{userid}_{fuserid}';

$config['K2032'] = 'Blogarticle_getSeo_{ArticleID}';

$config['K2033'] = 'getUserOnline_refresh_{uid}';

$config['K2034'] = 'getAffiche_byMid_again_{memberid}';

//获取用户基本信息
$config['K2035'] = 'blog_userBasicMessage_{UserID}';

$config['K2036'] = 'blog_userKeyStr_{UserID}';
