...
class Register extends MY_Controller {
    ...
    function Action() {
        ...
        if (FALSE === $BlogName || mb_strlen($BlogName, 'UTF-8') > 30) {
            ...
            $params['NickName'] = addslashes($this->user['nickname']);
    ...
    function Home() {
        ...
        $extract['user'] = $this->user;
        if ($extract['bloglist']['RetRecords'] < 1) {
            cnfolLocation($extract['baseurl'] . '/register/Register');
        }
        $this->load->view('register/RegIndex.shtml', $extract);
    }
    ...
    function verifycode() {
        ...
        //error_log(print_r($this->user['userid'], true).'|', 3, '/home/www/html/logs/a111.log');
