...
Popup.prototype = {
    ...
    build:function () {
        ...
        var mainBox = "<div id=\"dialogBox\" style=\"border:1px solid " + this.color.borderColor + ";display:none;z-index:" + showZIndex + ";position:relative;width:" + this.config.width + "px;\"><table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" bgcolor=\"" + this.color.bColor + "\">";
        if (this.config.isHaveTitle) {
        ...
        if (!this.config.isBackgroundCanClick) {
            ...
            //G("dialogBoxBG").style.width = document.body.offsetWidth+30;
            //alert(G("dialogBoxBG").style.width);
    ...
    lastBuild:function () {
        ...
        var loading = "<div style=\"width:100%;height:100%;text-align:center;\"><div style=\"margin:20px 20px 0 20px;font-size:14px;line-height:16px;color:#000000;\"><img src=\"http://img.cnfol.com/newblog/batev6.0/images/load.gif\" /></div></div>";
        var baseZIndex = 10001 + this.info.overlay * 10;
                ...
                if (this.config.contentType == 3) {
                    ...
                    if (this.config.contentType == 4) {
                        ...
                        if (this.config.contentType == 5) {
                            G("dialogBody").innerHTML = loading;
                        }
                    }
                }
            }
    ...
    middle:function () {
        ...
        //alert('sClientHeight: '+sClientHeight);
        //alert('sScrollTop: '+sScrollTop);
        //alert(document.documentElement.scrollTop);
    ...
    //alert('oDialog["style"]["left"] is '+oDialog["style"]["left"]);
    //alert('oDialog["style"]["top"] is '+oDialog["style"]["top"]);
    }, 
    reset:function () {
