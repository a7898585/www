...
//error_log(print_r($data,true).'|'.print_r($rs,true).'|'.$visivor, 3, '/home/www/html/logs/a123.log');
    ...
    function keywordFilter($data) {
        $data['Content'] = str_replace(config_item('keywordlist'), config_item('keywordclose'), $data['Content']);
        $data['Summary'] = str_replace(config_item('keywordlist'), config_item('keywordclose'), $data['Summary']);
        $data['Title'] = str_replace(config_item('keywordlist'), config_item('keywordclose'), $data['Title']);
        $data['TagIDs'] = str_replace(config_item('keywordlist'), config_item('keywordclose'), $data['TagIDs']);
        return $data;
    }
