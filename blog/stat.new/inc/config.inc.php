...
$config['blog_db'] = array(
    'hostname' => '172.20.1.235',
...
//博客点赞
$config['keys']['statday'] = 06;
$config['keys']['K2100'] = 'Blogarticle_goldstat_allcount';
$config['keys']['K2101'] = 'Blogarticle_goldstat_{nTimes}_{PageNo}_{PageSize}';
?>