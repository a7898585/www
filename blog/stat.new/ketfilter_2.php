...
function filterArticle($mem = 36, $year = '') {
    global $mysqli, $gjc;
...
error_log(date("Y-m-d H:i:s", time()) . " || ------start filterArticle-filter3-36---|\r\n", 3, BLOG_MANAGE_LOG . 'socket_keyfilter_load.log');

filterArticle(); //过滤文章内容

error_log(date("Y-m-d H:i:s", time()) . " || ------end filterArticle-filter3-36---|\r\n", 3, BLOG_MANAGE_LOG . 'socket_keyfilter_load.log');
