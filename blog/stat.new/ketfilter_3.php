...
function filterArticle($mem = 35, $year = '') {
    global $mysqli, $gjc;
...
error_log(date("Y-m-d H:i:s", time()) . " || ------start filterArticle-filter3-33---|\r\n", 3, BLOG_MANAGE_LOG . 'socket_keyfilter_load.log');

filterArticle(); //过滤文章内容

error_log(date("Y-m-d H:i:s", time()) . " || ------end filterArticle-filter3-33---|\r\n", 3, BLOG_MANAGE_LOG . 'socket_keyfilter_load.log');
