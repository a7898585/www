...
function show_error($message)
{
    ...
    //cnfol_CI
    echo $error->show_error('有错误发生', $message);
    exit;
}
...
/**
* Error Logging Interface For Cnfol
*
* We use this as a simple mechanism to access the logging
* class and send messages to be logged.
*
...
* @return   void
*/
function log_write($msg,$filename, $method, $logtype='INFO')
{
    static $CNFOL_LOG;
    ...
    $CNFOL_LOG =& load_class('Cnfol_log');
    $CNFOL_LOG->write_log($msg, $filename, $method, $logtype);
}
...
* @return   object
*/
function &load_class_params($class, $params=array())
{
    static $objects = array();
    ...
    if ($params == '')
    {
        ...
        $objects[$class] =& new $name($paramlist);
    }
