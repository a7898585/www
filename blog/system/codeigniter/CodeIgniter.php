...
// CI Version
define('CI_VERSION',	'cnfol_CI_1.0_pre');
...
if (file_exists(APPPATH.'config/costants'.EXT)) require(APPPATH.'config/constants'.EXT);
...
//cnfol_CI
if (!preg_match('/^[a-z]+$/', $class)) show_error('控制器名 <b>'. $class .'</b> 非法！控制器名称只允许使用小写的英文字母。');
