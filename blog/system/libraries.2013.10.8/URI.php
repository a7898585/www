...
class CI_URI {
	...
	function _fetch_uri_string()
	{
 		if (strtoupper($this->config->item('uri_protocol')) == 'AUTO')
		{
            ...
            // Is there a ORIG_PATH_INFO variable?
	...
	function _parse_request_uri()
	{
		...
		$request_uri = preg_replace("|/(.*)|", "\\1", str_replace("\\", "/", $_SERVER['REQUEST_URI']));
                #$request_uri = preg_replace("|/(.*)|", "\\1", str_replace("\\", "/", $_SERVER['SCRIPT_NAME']));
...
#echo 'uri';echo $_SERVER['SCRIPT_NAME'];echo 'uri';exit;
#var_dump($parsed_uri);echo 'cs';
		return $parsed_uri;
	}
