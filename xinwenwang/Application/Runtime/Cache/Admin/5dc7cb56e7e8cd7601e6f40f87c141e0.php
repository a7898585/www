                    ...
                    <div class="am-btn-toolbar am-fl">
                        ...
                        <div class="am-form-group am-margin-left am-fl">
                            <select name="show_type">
                                ...
                                <option value="1" <?php if(($_GET['show_type']) == "1"): ?>selected<?php endif; ?> >无图</option>
                                <option value="2" <?php if(($_GET['show_type']) == "2"): ?>selected<?php endif; ?> >单图</option>
                                <option value="3" <?php if(($_GET['show_type']) == "3"): ?>selected<?php endif; ?> >多图</option>
                                <option value="4" <?php if(($_GET['show_type']) == "4"): ?>selected<?php endif; ?> >广告</option>
                            </select>
                        </div>
                        <div class="am-form-group am-margin-left am-fl">
                            <select name="type_id">
                                <option value="0">新闻分类</option>
                                <?php if(is_array($type_list)): foreach($type_list as $key=>$item): ?><option value="<?php echo ($item["id"]); ?>" <?php if(($_GET['show_type']) == $item["id"]): ?>selected<?php endif; ?> ><?php echo ($item["title"]); ?></option><?php endforeach; endif; ?>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="am-u-sm-12">
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
                            ...
                            <td><a target="_blank" href="<?php echo (C("HOME_URL")); ?>r<?php echo ($item["id"]); ?>/"><?php echo ($item['title']); ?></a></td>
                            <td class="table-author"><?php echo (getTypeName($item["type_id"])); ?></td>
                            <td class="table-author"><?php echo (showTypes($item["show_type"])); ?></td>
                            <td class="table-date"><?php echo ($item["comment_sum"]); ?></td>
                            <td class="table-date"><?php echo ($item["good_sum"]); ?></td>
                            <td class="table-date"><?php echo (fdate($item["update_time"])); ?></td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a href="/news/news_info?id=<?php echo ($item["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                        <a href="javascript:delNews(<?php echo ($item["id"]); ?>);" class="am-btn am-btn-default am-btn-xs am-text-danger"><span class="am-icon-trash-o"></span> 删除</a>
                ...
                <div class="am-cf">
                    共 <?php echo ($page['totalCount']); ?> 条记录
                    <div class="am-fr">
                        <?php echo ($pager); ?>
                    </div>
                </div>
