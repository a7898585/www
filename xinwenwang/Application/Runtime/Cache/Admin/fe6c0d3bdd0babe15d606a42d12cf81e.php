...
<html class="no-js">
    ...
    <ol class="am-breadcrumb am-breadcrumb-slash" style="padding-bottom: 0;">
        ...
        <li><a href="/friends/add">友情链接管理</a></li>
            ...
            <div class="am-fl am-cf">
                <div class="am-btn-toolbar am-fl">
                    <div class="am-btn-group am-btn-group-xs">
                        <a href="/friends/add" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
                    </div>
                </div>
            </div>
        </div>
        <form action="/friends/all" method="get">
            ...
            <div class="am-u-sm-12">
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <?php if(is_array($items)): foreach($items as $key=>$item): ?><tr>
                            ...
                            <td>
                                <a href="/friends/edit?id=<?php echo ($item["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                <a href="/friends/delete?id=<?php echo ($item["id"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="return confirm('确认删除该链接吗？')"><span class="am-icon-pencil-square-o"></span> 删除</a>
                            </td>
