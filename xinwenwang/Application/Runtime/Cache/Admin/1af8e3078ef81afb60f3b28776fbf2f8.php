...
<html class="no-js">
    ...
    <div class="am-g">
        <form action="/news/news_subject" method="get">
            ...
            <div class="am-u-sm-12">
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr>
                            ...
                            <td><?php echo ($item['is_default'] ? '是':'否'); ?></td>
                            <td><?php echo ($item['is_show']? '是':'否'); ?></td>
                            <td><?php echo ($item['is_subject']? '是':'否'); ?></td>
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        ...
                                        <!--<a href="javascript:delNewsType(<?php echo ($item["id"]); ?>);" class="am-btn am-btn-default am-btn-xs am-text-danger"><span class="am-icon-trash-o"></span> 删除</a>-->
                                        <a href="/news/news_info/?type_id=<?php echo ($item["id"]); ?>&show_type=<?php echo ($item["show_type"]); ?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 添加文章</a>
                                    </div>
                                </div>
                            </td>
